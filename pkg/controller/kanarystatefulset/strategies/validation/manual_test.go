...
func Test_manualImpl_Validation(t *testing.T) {
	...
	var (
		...
		defaultValidationSpec = &kanaryv1alpha1.KanaryStatefulsetSpecValidationList{
		...
		validatedManualSpec = &kanaryv1alpha1.KanaryStatefulsetSpecValidationList{
			Items: []kanaryv1alpha1.KanaryStatefulsetSpecValidation{
				{
					Manual: &kanaryv1alpha1.KanaryStatefulsetSpecValidationManual{
						Status: kanaryv1alpha1.ValidKanaryStatefulsetSpecValidationManualStatus,
					},
				},
			},
	...
	tests := []struct {
	...
	}{
		{
			...
			args: args{
				...
				kd:        kanaryv1alpha1test.NewKanaryStatefulset(name, namespace, "", defaultReplicas, &kanaryv1alpha1test.NewKanaryStatefulsetOptions{Validations: defaultValidationSpec}),
		...
		},
		{
			...
			fields: fields{
				deadlineStatus:         kanaryv1alpha1.NoneKanaryStatefulsetSpecValidationManualDeadineStatus,
				validationManualStatus: kanaryv1alpha1.ValidKanaryStatefulsetSpecValidationManualStatus,
			},
			args: args{
				kd:        kanaryv1alpha1test.NewKanaryStatefulset(name, namespace, "", defaultReplicas, &kanaryv1alpha1test.NewKanaryStatefulsetOptions{Validations: validatedManualSpec}),
				dep:       utilstest.NewDeployment(name, namespace, defaultReplicas, nil),
				canaryDep: utilstest.NewDeployment(name+"-kanary", namespace, 1, nil),
				kclient: fake.NewFakeClient([]runtime.Object{
					utilstest.NewDeployment(name, namespace, defaultReplicas, nil),
					kanaryv1alpha1test.NewKanaryStatefulset(name, namespace, "", defaultReplicas, &kanaryv1alpha1test.NewKanaryStatefulsetOptions{Validations: validatedManualSpec}),
				}...),
			},
			want: &Result{
				IsFailed:        false,
		...
		},
		{
			...
			fields: fields{
				deadlineStatus:         kanaryv1alpha1.NoneKanaryStatefulsetSpecValidationManualDeadineStatus,
				validationManualStatus: kanaryv1alpha1.InvalidKanaryStatefulsetSpecValidationManualStatus,
			},
			args: args{
				kd:        kanaryv1alpha1test.NewKanaryStatefulset(name, namespace, "", defaultReplicas, &kanaryv1alpha1test.NewKanaryStatefulsetOptions{Validations: validatedManualSpec}),
				dep:       utilstest.NewDeployment(name, namespace, defaultReplicas, nil),
		...
		},
		{
			...
			fields: fields{
				deadlineStatus:         kanaryv1alpha1.ValidKanaryStatefulsetSpecValidationManualDeadineStatus,
				validationManualStatus: "",
			},
			args: args{
				kd:        kanaryv1alpha1test.NewKanaryStatefulset(name, namespace, "", defaultReplicas, &kanaryv1alpha1test.NewKanaryStatefulsetOptions{StartTime: &creationTime, Validations: validatedManualSpec}),
		...
		},
		{
			...
			fields: fields{
				deadlineStatus:         kanaryv1alpha1.InvalidKanaryStatefulsetSpecValidationManualDeadineStatus,
				validationManualStatus: "",
			},
			args: args{
				kd:        kanaryv1alpha1test.NewKanaryStatefulset(name, namespace, "", defaultReplicas, &kanaryv1alpha1test.NewKanaryStatefulsetOptions{StartTime: &creationTime, Validations: validatedManualSpec}),
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			got, err := m.Validation(tt.args.kclient, reqLogger, tt.args.kd, tt.args.dep, tt.args.canaryDep, nil)
